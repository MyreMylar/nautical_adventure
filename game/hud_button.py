...
class HUDButton:
    def __init__(self, start_pos, button_image_name, hud_sprites):
        ...
        self.image = pygame.image.load("images/hud_icons/" + self.button_image_name + "_unselected.png")
        ...
        self.cost_text_render = self.font.render(cost_string, True, pygame.Color(255, 255, 255))
    ...
    def update_text_values(self, value):
        ...
        if self.text_value > 0:
            ...
            cost_string = "{:,}".format(self.text_value)
            text_colour = pygame.Color(250, 50, 50)
    ...
    def set_selected(self):
        self.selected = True
        self.sprite.image = self.image_selected
